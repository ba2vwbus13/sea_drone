...
class Controller:
    def __init__(self):
        ...
        self.pwm_L.start(self.ratio_to_duty_L(0.5)) 
        self.pwm_R.start(self.ratio_to_duty_R(0.5)) 
        rospy.Timer(rospy.Duration(0.1), self.timer_callback) #0.3:wait
    ...
    def timer_callback(self, event):
        self.pwm_L.ChangeDutyCycle(self.ratio_to_duty_L(0.3)) 
        self.pwm_R.ChangeDutyCycle(self.ratio_to_duty_R(0.3)) 
